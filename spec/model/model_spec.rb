...
class Answer < Maglev::Model
  remote_attribute :id

  belongs_to :question
end

class Question < Maglev::Model
  remote_attributes :id, :question
...
describe "The active record-esque stuff" do
  ...
  it "works with camel cased models" do
    ...
    c.another_camel_case_model = AnotherCamelCaseModel.new(id: 8)
    c.another_camel_case_model.id.should == 8

    #c.setBunchOfCamelCaseModels([{}, {}, {}])
    c.bunch_of_camel_case_models = [{}, {}, {}]
